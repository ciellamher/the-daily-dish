...
export const RECIPES = [
  {
    ...
    sourceUrl: "https://www.seriouseats.com/shrimp-scampi-pasta-recipe",
  ...
  },
  {
    ...
    sourceUrl: "https://sallysbakingaddiction.com/creamy-tuscan-chicken/",
  ...
  },
  {
    ...
    description: "A refreshing, vibrant salad combining sweet strawberries, juicy blackberries, creamy avocado slices, and tangy crumbled feta on a bed of fresh baby spinach.",
    image: "assets/images/avocado_salad.png",
    sourceUrl: "https://www.foodnetwork.com/recipes/summer-berry-avocado-salad-recipe",
  ...
  },
  {
    ...
    description: "The ultimate chocolate chip cookies: buttery, soft-baked, chewy, and loaded with pockets of warm, melted semi-sweet chocolate chips.",
  ...
  },
  {
    ...
    description: "Creamy mashed avocado seasoned with sea salt and lemon juice, spread over thick toasted sourdough bread and topped with red pepper flakes and microgreens.",
    image: "",
    sourceUrl: "https://www.seriouseats.com/avocado-toast-with-poached-egg-recipe",
    sourceName: "Serious Eats",
    prepTime: 5,
    cookTime: 5,
    servings: 1,
  ...
  },
  {
    ...
    description: "A rich and comforting soup made from slow-roasted tomatoes, fresh garlic, caramelized onions, and sweet basil leaves, simmered with cream.",
    image: "",
    sourceUrl: "https://www.seriouseats.com/easy-roasted-tomato-soup-recipe",
    sourceName: "Serious Eats",
    prepTime: 10,
    cookTime: 30,
    servings: 4,
  ...
  },
  {
    ...
    description: "A diner-style seared beef patty with melted American cheese, lettuce, tomato, pickles, and classic burger sauce on a toasted potato bun.",
    image: "",
    sourceUrl: "https://www.seriouseats.com/the-burger-lab-the-ingredients-for-the-perfect-cheeseburger",
    sourceName: "Serious Eats",
    prepTime: 10,
    cookTime: 10,
    servings: 2,
  ...
  },
  {
    ...
    description: "Double-fried russet potatoes tossed with aromatic minced garlic, chopped fresh parsley, sea salt, and a touch of parmesan cheese.",
    image: "",
    sourceUrl: "https://www.seriouseats.com/perfect-french-fries-recipe",
    sourceName: "Serious Eats",
    prepTime: 15,
    cookTime: 25,
    servings: 4,
  ...
  },
  {
    ...
    description: "Quick fettuccine pasta tossed in a rich, velvety cream sauce loaded with minced garlic and freshly grated parmesan cheese.",
    image: "",
    sourceUrl: "https://www.seriouseats.com/fast-easy-pasta-garlic-parmesan-cream-sauce-recipe",
    sourceName: "Serious Eats",
    prepTime: 5,
    cookTime: 15,
    servings: 4,
  ...
  },
  {
    ...
    description: "Classic thick and fluffy pancakes packed with fresh, bursting blueberries and served with warm maple syrup.",
    image: "",
    sourceUrl: "https://www.seriouseats.com/light-and-fluffy-pancakes-recipe",
    sourceName: "Serious Eats",
    prepTime: 10,
    cookTime: 15,
    servings: 3,
  ...
  },
  {
    ...
    description: "A rustic Neapolitan-style thin crust pizza topped with fresh tomato sauce, creamy mozzarella slices, and fragrant whole basil leaves.",
    image: "",
    sourceUrl: "https://www.seriouseats.com/basic-new-york-style-pizza-dough",
    sourceName: "Serious Eats",
    prepTime: 20,
    cookTime: 12,
    servings: 2,
