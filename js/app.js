...
import { simulateRecipeImport, parseSchemaIngredients } from "./components/importer.js?v=2.5";
import { generateRecipeOnSpot } from "./components/generator.js?v=2.5";
import { escapeHtml, ICONS, startAmbientAudio, stopAmbientAudio } from "./utils.js?v=2.5";
import { initRecipeChatbot } from "./components/recipe-chatbot.js?v=2.5";
